...
class AvatarsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create avatar" do
    assert_difference('Avatar.count') do
      post avatars_url, params: { avatar: { name: @avatar.name, user_id: @avatar.user_id } }, as: :json
    end
  ...
  test "should update avatar" do
    patch avatar_url(@avatar), params: { avatar: { name: @avatar.name, user_id: @avatar.user_id } }, as: :json
    assert_response 200
  end
